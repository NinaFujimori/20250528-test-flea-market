...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => 'storage/products/kiwi.jpg',
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => 'storage/products/strawberry.jpg',
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => 'storage/products/orange.jpg',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => 'storage/products/watermelon.jpg',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => 'storage/products/peach.jpg',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => 'storage/products/muscat.jpg',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => 'storage/products/pineapple.jpg',
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => 'storage/products/banana.jpg',
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => 'storage/products/melon.jpg',
